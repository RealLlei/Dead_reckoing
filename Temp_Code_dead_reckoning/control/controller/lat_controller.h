...
class LatController : public Controller {
 public:
   ...
   */
  common::Status ComputeControlCommand(ControlCommand* cmd) override;
 ...
 protected:
  ...
  void UpdateMatrix(const double v);
  ...
  void CloseLogFile();
  void UpdateMatrixKMap();

  // vehicle
  const ControlConf* control_conf_ = nullptr;

  // vehicle parameter
  ::TL::control::LatControllerConf lat_controller_conf_;
  ...
  common::MeanFilter target_heading_filiter_;
  ...
  std::unordered_map<int, Eigen::MatrixXd> matrix_k_map_;

  // PID controller
  PIDController steer_pid_controller_;
