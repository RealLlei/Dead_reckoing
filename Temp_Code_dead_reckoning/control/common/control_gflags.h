...
// calibration table
DECLARE_string(matrix_k_map_file);
DECLARE_string(calibration_table_file);
// mbd controller conf file
DECLARE_string(mbd_ctrl_conf_file);
...
DECLARE_double(steer_offset);

DECLARE_double(control_delay_compensation);

DECLARE_double(steer_angle_limit);
DECLARE_double(steer_angle_limit_first);

DECLARE_int32(control_delay_time);

DECLARE_bool(enable_mpc_calibration);

DECLARE_bool(enable_pid_speedsegment_control);

DECLARE_bool(enable_steer_2_torque);

DECLARE_bool(enable_teleop);
DECLARE_bool(enable_teleop_pid_calculate);
DECLARE_bool(enable_teleop_steer_torque);
...
DECLARE_double(steer_2_torque_right);
DECLARE_double(steer_2_torque_left);
DECLARE_bool(enable_steer_segment_feedforward);
DECLARE_bool(enable_torque_gradient_protection);
DECLARE_bool(enable_mbd_control);
DECLARE_bool(use_localization_timestamp_for_control);
DECLARE_double(set_localization_control_time_gap);
