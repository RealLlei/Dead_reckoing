...
class TrajectoryAnalyzer {
 public:
  ...
  bool ComputeReferenceInfo(const common::PathPoint& origin_point,
                            double base_time, double ts, int horizon,
                            double current_v, int state_size,
 ...
 private:
  ...
  common::TrajectoryPoint PointTransformToRelativeCoordinate(
