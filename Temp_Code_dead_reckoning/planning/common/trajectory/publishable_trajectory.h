#ifndef PLANNING_COMMON_TRAJECTORY_PUBLISHABLE_TRAJECTORY_H
#define PLANNING_COMMON_TRAJECTORY_PUBLISHABLE_TRAJECTORY_H
...
class PublishableTrajectory : public DiscretizedTrajectory {
 public:
  PublishableTrajectory() = delete;

  PublishableTrajectory(double header_time,
  ...
  void set_header_time(double time) { header_time_ = time; }
...
#endif  // PLANNING_COMMON_TRAJECTORY_PUBLISHABLE_TRAJECTORY_H
