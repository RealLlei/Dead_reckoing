...
class HistoryFrame {
 public:
  ...
  void Init(const std::shared_ptr<const ADCTrajectory>& adc_trajactory);
...
class HistoryObjectStatus {
 public:
  ...
  ObjectStatus GetObjectStatus() const { return object_status_; }
...
class HistoryStatus {
 public:
  ...
  bool GetObjectStatus(const std::string& id, ObjectStatus* object_status);
...
class History {
 public:
  ...
  int Add(const std::shared_ptr<const ADCTrajectory>& adc_trajectory_pb);
  void Clear();
  size_t Size() const;
