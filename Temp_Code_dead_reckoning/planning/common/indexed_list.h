...
class IndexedList {
 public:
   ...
   */
  T* Find(const I id) {
    return TL::common::util::FindOrNull(object_dict_, id);
  }
  ...
  /**
   * @brief List all the items in the container and can be written.
   * @return the unordered_map of ids and objects in the container.
   */
  std::unordered_map<I, T>& MutableDict() { return object_dict_; }
