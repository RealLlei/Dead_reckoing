#ifndef PLANNING_COMMON_PATH_BOUNDARY_H
#define PLANNING_COMMON_PATH_BOUNDARY_H
/******************************************************************************
...
class PathBoundary {
 public:
  PathBoundary(double start_s, double delta_s,
  ...
  size_t GetNearestPathBoundIndex(double s) const;

  const std::pair<double, double>& GetPathBoundAtS(double s) const;
...
#endif  // PLANNING_COMMON_PATH_BOUNDARY_H
