...
ConstantJerkTrajectory1d::ConstantJerkTrajectory1d(const double p0,
  ...
  p1_ = ConstantJerkTrajectory1d::Evaluate(0, param_);
  v1_ = ConstantJerkTrajectory1d::Evaluate(1, param_);
  a1_ = ConstantJerkTrajectory1d::Evaluate(2, param_);
}

void ConstantJerkTrajectory1d::Init() {
