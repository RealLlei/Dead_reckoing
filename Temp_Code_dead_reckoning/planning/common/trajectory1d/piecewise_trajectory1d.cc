...
#include "planning/common/trajectory1d/piecewise_trajectory1d.h"
...
double PiecewiseTrajectory1d::Evaluate(const std::uint32_t order,
  ...
  size_t index =
      static_cast<size_t>(it_lower - accumulated_param_lengths_.begin());
...
std::string PiecewiseTrajectory1d::ToString() const {
  return "";
}
