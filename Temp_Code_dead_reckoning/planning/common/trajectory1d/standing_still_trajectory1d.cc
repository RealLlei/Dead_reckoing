...
#include "planning/common/trajectory1d/standing_still_trajectory1d.h"
...
double StandingStillTrajectory1d::Evaluate_v(const double /*t*/) {
  return 0.0;
}

double StandingStillTrajectory1d::Evaluate_a(const double /*t*/) {
  return 0.0;
}

double StandingStillTrajectory1d::Evaluate_j(const double /*t*/) {
  return 0.0;
}
