 ...
 */
class alignas(CACHELINE_SIZE) LaneContinueEvaluator : public SpeedEvaluator {
 public:
  explicit LaneContinueEvaluator(const SpeedEvaluatorConfig& config);
 ...
 private:
  ...
  LaneContinueEvaluatorConfig config_;
};
