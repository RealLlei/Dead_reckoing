 ...
 */
class alignas(CACHELINE_SIZE) LaneMergeStopEvaluator : public SpeedEvaluator {
 public:
  explicit LaneMergeStopEvaluator(const SpeedEvaluatorConfig& config);
 ...
 private:
  ...
  LaneMergeStopEvaluatorConfig config_;
};
