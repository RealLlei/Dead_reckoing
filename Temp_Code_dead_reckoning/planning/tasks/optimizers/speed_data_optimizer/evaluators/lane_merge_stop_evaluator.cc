...
LaneMergeStopEvaluator::LaneMergeStopEvaluator(
    const SpeedEvaluatorConfig& config)
    : SpeedEvaluator(config),
      config_(config.lane_merge_stop_evaluator_config()) {
...
void LaneMergeStopEvaluator::CalculateCost(
...
bool LaneMergeStopEvaluator::CheckFallbackSpeedData(
    const SpeedCache& cache, const ReferenceLineInfo& reference_line_info,
...
void LaneMergeStopEvaluator::CalculateModeCost(
...
void LaneMergeStopEvaluator::CalculateTotalCost(
    const SpeedCurveCostResult* cost_result1,
...
bool LaneMergeStopEvaluator::CompareCostResult(
    const SpeedCurveCostResult* cost_result1,
...
bool LaneMergeStopEvaluator::CompareCurrentCostResult(
    const SpeedCurveCostResult* cost_result1,
    const SpeedCurveCostResult* cost_result2) const {
  if (cost_result1 == nullptr || cost_result1->curve == nullptr) {
    return false;
...
bool LaneMergeStopEvaluator::CompareCurrentAndLastCostResult(
