...
/**
 * @class LaneChangeOngoingEvaluator
 * @brief This class defines the highway speed curve evaluation method
 */
class alignas(CACHELINE_SIZE) LaneChangeOngoingEvaluator
    : public SpeedEvaluator {
 public:
  explicit LaneChangeOngoingEvaluator(const SpeedEvaluatorConfig& config);
 ...
 private:
  ...
  LaneChangeOngoingEvaluatorConfig config_;
};
