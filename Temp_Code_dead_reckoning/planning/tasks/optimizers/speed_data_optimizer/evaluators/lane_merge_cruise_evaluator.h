 ...
 */
class alignas(CACHELINE_SIZE) LaneMergeCruiseEvaluator : public SpeedEvaluator {
 public:
  explicit LaneMergeCruiseEvaluator(const SpeedEvaluatorConfig& config);
 ...
 private:
  ...
  LaneMergeCruiseEvaluatorConfig config_;
};
