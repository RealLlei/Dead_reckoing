 ...
 * Description:  ipopt_pos_optimize_math_model.h
 */
...
class IpoptPosOptimizeMathModel : public Ipopt::TNLP {
 public:
  IpoptPosOptimizeMathModel(IpoptPosOptimizeMathModel&&) = delete;
  IpoptPosOptimizeMathModel& operator=(IpoptPosOptimizeMathModel&&) = delete;
  explicit IpoptPosOptimizeMathModel(
      IpoptPosOptimizeMathModelParam nlp_input_param);

  ~IpoptPosOptimizeMathModel() override = default;
   ...
   */
  void SparseJacobianMatrix(const Ipopt::Index& m, const Ipopt::Index& n,
                            const Ipopt::Number* x,
                            std::vector<Ipopt::Index>* nonzero_row,
                            std::vector<Ipopt::Index>* nonzero_col,
                            std::vector<Ipopt::Number>* nonzero_values) const;
   ...
   * @param nonzero_values 
   */
  void SparseHessianMatrix(const Ipopt::Index& m, const Ipopt::Index& n,
 ...
 private:
  IpoptPosOptimizeMathModel(const IpoptPosOptimizeMathModel&);
  IpoptPosOptimizeMathModel& operator=(const IpoptPosOptimizeMathModel&);

  const IpoptPosOptimizeMathModelParam nlp_input_param_;
