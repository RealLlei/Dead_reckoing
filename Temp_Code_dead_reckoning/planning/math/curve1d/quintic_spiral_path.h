...
class QuinticSpiralPath : public QuinticPolynomialCurve1d {
 public:
  ...
  QuinticSpiralPath(const std::array<double, 3>& start,
                    const std::array<double, 3>& end, double delta_s);

  QuinticSpiralPath(double theta0, double kappa0, double dkappa0, double theta1,
                    double kappa1, double dkappa1, double delta_s);
  ...
  double DeriveKappaDerivative(size_t param_index, double ratio) const;

  double DeriveDKappaDerivative(size_t param_index, double ratio) const;

  double DeriveD2KappaDerivative(size_t param_index, double r) const;
 ...
 private:
  double DeriveTheta(size_t param_index, double r) const;
