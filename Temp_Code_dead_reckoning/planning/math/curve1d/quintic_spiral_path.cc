...
#include "planning/math/curve1d/quintic_spiral_path.h"
...
double QuinticSpiralPath::DeriveTheta(const size_t param_index,
  ...
  double derivative = coef_deriv_[5].at(param_index) * s5 +
                      coef_deriv_[4].at(param_index) * s4 +
                      coef_deriv_[3].at(param_index) * s3 +
                      coef_deriv_[2].at(param_index) * s2 +
                      coef_deriv_[1].at(param_index) * s +
                      coef_deriv_[0].at(param_index);
...
double QuinticSpiralPath::DeriveKappaDerivative(const size_t param_index,
  ...
  double derivative = 5.0 * coef_deriv_[5].at(param_index) * s4 +
                      4.0 * coef_deriv_[4].at(param_index) * s3 +
                      3.0 * coef_deriv_[3].at(param_index) * s2 +
                      2.0 * coef_deriv_[2].at(param_index) * s +
                      coef_deriv_[1].at(param_index);
...
double QuinticSpiralPath::DeriveDKappaDerivative(const size_t param_index,
  ...
  double derivative = 20.0 * coef_deriv_[5].at(param_index) * s3 +
                      12.0 * coef_deriv_[4].at(param_index) * s2 +
                      6.0 * coef_deriv_[3].at(param_index) * s +
                      2.0 * coef_deriv_[2].at(param_index);
...
double QuinticSpiralPath::DeriveD2KappaDerivative(const size_t param_index,
  ...
  double derivative = 60.0 * coef_deriv_[5].at(param_index) * s2 +
                      24.0 * coef_deriv_[4].at(param_index) * s +
                      6.0 * coef_deriv_[3].at(param_index);
