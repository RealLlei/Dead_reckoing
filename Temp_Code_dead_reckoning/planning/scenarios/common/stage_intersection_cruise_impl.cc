...
#include "planning/scenarios/common/stage_intersection_cruise_impl.h"
...
bool StageIntersectionCruiseImpl::CheckDone(
  ...
  if (pnc_junction_overlaps.empty()) {
    ...
    if (scenario_type == ScenarioStatus::STOP_SIGN_PROTECTED ||
    ...
    } else if (scenario_type == ScenarioStatus::TRAFFIC_LIGHT_PROTECTED ||
               scenario_type ==
                   ScenarioStatus::TRAFFIC_LIGHT_UNPROTECTED_LEFT_TURN ||
               scenario_type ==
                   ScenarioStatus::TRAFFIC_LIGHT_UNPROTECTED_RIGHT_TURN) {
    ...
    } else if (scenario_type == ScenarioStatus::YIELD_SIGN) {
