...
bool CheckPullOverPositionBySL(const ReferenceLineInfo& reference_line_info,
                               ...
                               double target_theta, bool check_s);

bool CheckADCReadyToCruise(const common::VehicleState* vehicle_state,
                           Frame* frame,
                           const ScenarioParkAndGoConfig& scenario_config);

bool CheckADCSurroundObstacles(common::math::Vec2d adc_position,
                               double adc_heading, Frame* frame,
                               double front_obstacle_buffer);

bool CheckADCHeading(common::math::Vec2d adc_position, double adc_heading,
                     const ReferenceLineInfo& reference_line_info,
                     double heading_diff_to_reference_line);
