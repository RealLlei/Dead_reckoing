...
#define CTA_MAX_NUM_OBJECTS 80u             // 160 -->80;
#define FCTA_MAX_NUM_OBJECTS 80u            // 80
#define RCTA_MAX_NUM_OBJECTS 80u            // 80
#define CTA_FCTA_CFG_NUM_OF_WARN_LEVELS 2u  // 1 --> 2
#define CTA_RCTA_CFG_NUM_OF_WARN_LEVELS 2u  // 3 --> 2
...
#define CTA_EM_GEN_OBJECT_DYN_PROPERTY_STOPPED 7u
#define CTA_CT_LPF_DIST2CROSS_FILTER 0.1f
#define CTA_CT_XBREAKTHROUGH_MIN_FILTER 10.f
#define CTA_CT_LARGE_TTC 30.f
#define CTA_CT_TTCFILTER_MAX_DIST2CROS 5.f
#define CTA_CT_TTCFILTER_DOWN_MIN_ALPHA 0.1f
#define CTA_CT_TTCFILTER_DOWN_MAX_ALPHA 0.5f
...
#define CTA_LPF_VRELXY_ALPHA 0.9f
...
#define FCTA_QUALITY_POE_MIN 0.6f

#define FCTA_LI_UPDATE_MIN_SPEED 30.0f * TUE_C_MS_KMH  // 30 m/s * 0.2 = 6 m/s

#define FCTA_LI_UPDATE_MAX_SPEED \
  60.0f * TUE_C_MS_KMH  // 60 m/s * 0.2 = 12 m / s
...
#define FCTA_BREAKTHROUGH_MIN_SPEED 0.5f
#define FCTA_BREAKTHROUGH_MAX_CURVE 0.5f

#define FCTA_CONFI_UPDATE_MAX 200.f  //  20-->15   JO
#define FCTA_CONFI_UPDATE_MIN 50.f   //  5-->15   JO
#define FCTA_CONFI_UPDATE_MAX_EFOV 100.f
#define FCTA_CONFI_UPDATE_MIN_EFOV 20.f  //  2-->10   JO

#define FCTA_TTC_EFOV_THRESH 1.f
#define FCTA_SHORT_WARNING_THRESH 0.1f
#define FCTA_SHORT_WARN_DIST_THRESH 1.0f
#define FCTA_SHORTWARN_CLOSEOBJ_TTC_THR 0.1f
#define FCTA_APPROACH_ANGLE_HYST 5.f
...
#define FCTA_OBJ_VALID_VABS_MAX 5 / 3.6f
#define FCTA_VX_DIFF_MOV_INVALID 1.5f
#define FCTA_VX_DIFF_MOV_VALID 2.0f
...
#define FCTA_VEGO_THRESH_STAT2MOV 0.5f
...
#define FCTA_MAX_Y_GEN_RELEVANCE 10.f
#define FCTA_REL_LIFECYCLE_MIN 2u
#define FCTA_REL_VRELX_MAX 2.5f
#define FCTA_MIN_LIFECYCLE_RELEVANT 2u
#define FCTA_HIT_CONFI_THRESH 70u
#define FCTA_RCS_THRESH -20.f

// RCTA
//#define  CTA_RCTA_CFG_NUM_OF_WARN_LEVELS 3u
// redefined; Same value as  CTA_RCTA_CFG_NUM_OF_WARN_LEVELS

// set number of warning parameters which can be calculated. Valid range
// is 1 to 3
...
#define RCTA_APPROACH_ANGLE_HYST 5.f
...
#define RCTA_RELEVANCE_LIFECYCLE_MIN 2u
...
#define RCTA_HIT_CONFI_THRESH 70u
