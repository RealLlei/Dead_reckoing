...
#include "planning/prediction/network/net_util.h"

#pragma once

/**
 * @namespace TL::prediction::network
 * @brief TL::prediction::network
 */
namespace TL {
...
class Layer {
 public:
   ...
   */
  virtual bool Load(const TL::prediction::LayerParameter& layer_pb);
...
class Dense : public Layer {
 public:
   ...
   */
  bool Load(const TL::prediction::LayerParameter& layer_pb) override;
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const TL::prediction::DenseParameter& layer_pb);
...
class Conv1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const TL::prediction::Conv1dParameter& conv1d_pb);
...
class MaxPool1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const TL::prediction::MaxPool1dParameter& maxpool1d_pb);
...
class AvgPool1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const TL::prediction::AvgPool1dParameter& avgpool1d_pb);
...
class Activation : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const TL::prediction::ActivationParameter& activation_pb);
