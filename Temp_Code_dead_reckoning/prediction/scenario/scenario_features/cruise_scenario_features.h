...
class CruiseScenarioFeatures : public ScenarioFeatures {
 public:
  ...
  ~CruiseScenarioFeatures() override;

  CruiseScenarioFeatures(const CruiseScenarioFeatures&) = default;
  CruiseScenarioFeatures& operator=(const CruiseScenarioFeatures&) = default;
  CruiseScenarioFeatures(CruiseScenarioFeatures&&) = default;
  CruiseScenarioFeatures& operator=(CruiseScenarioFeatures&&) = default;
