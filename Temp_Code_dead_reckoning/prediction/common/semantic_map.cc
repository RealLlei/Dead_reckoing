...
#include "planning/prediction/common/semantic_map.h"
...
void SemanticMap::DrawRoads(const common::PointENU& center_point,
  ...
  std::vector<TL::hdmap::RoadInfoConstPtr> roads;
  TL::hdmap::HDMapUtil::MapForPrediction().GetRoads(center_point, 141.4,
                                                       &roads);
...
void SemanticMap::DrawJunctions(const common::PointENU& center_point,
                                const double base_x, const double base_y,
                                const cv::Scalar& color) {
  std::vector<TL::hdmap::JunctionInfoConstPtr> junctions;
  TL::hdmap::HDMapUtil::MapForPrediction().GetJunctions(center_point, 141.4,
                                                           &junctions);
...
void SemanticMap::DrawCrosswalks(const common::PointENU& center_point,
                                 const double base_x, const double base_y,
                                 const cv::Scalar& color) {
  std::vector<TL::hdmap::CrosswalkInfoConstPtr> crosswalks;
  TL::hdmap::HDMapUtil::MapForPrediction().GetCrosswalks(center_point, 141.4,
                                                            &crosswalks);
...
void SemanticMap::DrawLanes(const common::PointENU& center_point,
  ...
  TL::hdmap::HDMapUtil::MapForPrediction().GetLanes(center_point, 141.4,
                                                       &lanes);
