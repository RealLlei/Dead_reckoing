...
DECLARE_bool(enable_online_record4Prediction);
...
DECLARE_bool(enable_prediction_debug);
DECLARE_int32(prediction_debug_history_frame_num);
DECLARE_double(offline_mode_start_timestamp);
DECLARE_double(offline_mode_end_timestamp);
