...
#include "planning/prediction/proto/offline_features.pb.h"
...
class FeatureOutput {
 public:
  ...
  static void InsertDataForTuning(
      ...
      const std::vector<TL::common::TrajectoryPoint>& adc_trajectory);
  ...
  static inline std::string UnixSecondsToString(
